...
#
cp ~/src/scripts/SurfaceAddWaterColor-Erosion.fs ~/src/SARndbox-2.8/share/SARndbox-2.8/Shaders/SurfaceAddWaterColor.fs
echo 'Switching to Erosion.'
echo "erosion" > ~/src/scripts/weather_file.tmp
